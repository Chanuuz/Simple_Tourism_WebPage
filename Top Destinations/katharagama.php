...
<body>
    ...
    <main>
        <section class="destination-content">
            <h1>Katharagama</h1>
            <img src="../assets/kataragama.jpg" alt="Katharagama" class="destination-image">
            <p>
                Katharagama is a sacred pilgrimage town in southern Sri Lanka, attracting devotees from all religions. 
                Visit the Katharagama Temple and enjoy the cultural festivities.
            </p>
            <h3>Ratings: ★★★★☆ (4.6/5)</h3>
            <h4>How to Travel</h4>
            <p>
                Book a trip with us to explore the spiritual side of Sri Lanka with ease and comfort.
            </p>
